      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => NoteEdit(note: new Note()))).then((v) {
              refresh();
            });
          },
        ),
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: ListTile(
                ...
                onTap: () {
                  setState(() => loading = true);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => NoteEdit(note: note))).then((v) {
                    refresh();
                  });
                },
              ),
